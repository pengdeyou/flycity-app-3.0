...
import AboutAuthorPage from './UserAbout';
        ...
        return(
            <View style={[styles.container, {backgroundColor: pageBackgroundColor}]}>
                ...
                <View style={styles.logoInfo}>
                    ...
                    <Text style={[{color: titleColor}, styles.logoLabel]}>wxcs.io</Text>
                ...
                <View style={[styles.block, {borderTopColor: segmentColor, backgroundColor: rowItemBackgroundColor}]}>
                    ...
                    <Item title="作者" arrowColor={arrowColor} titleColor={titleColor} segmentColor={segmentColor}  onPress={this._itemOnPressCallback.bind(this, 2)}/>
                </View>
                <View style={{position: 'absolute', bottom: px2dp(15), width:theme.screenWidth, alignItems: 'center'}}>
                    <Text style={{color: tabIconColor, fontSize: px2dp(12)}}>Copyright (C)2017 wxcs.io</Text>
                </View>
            </View>
        );
    }
